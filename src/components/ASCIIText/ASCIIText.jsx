    ...
    >
      <style>{`
        ...
        .ascii-text-container canvas {
          ...
          /* Hide the blocky color underlay so only the clean lime ASCII glyphs show.
             The ASCII is sampled from this canvas's backing store, so hiding it
             visually does not affect the effect. */
          opacity: 0;
        }
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          /* Carbon/lime palette to match the site theme. Normal blend so glyphs
             render as true lime (the original 'difference' blend inverted them
             into a rainbow speckle). */
          background-image: radial-gradient(circle, #dcff7a 0%, #C8FF34 55%, #8fb320 100%);
